...
--------------------------------------------------
    ...
    (or)- vec_ts.h: https://gist.github.com/mrbid/9d8831feae1a6881c95434c4006a7229
...
const GLchar* f2 = 
    ...
    "{\n"
        ...
        "vec3 specColor = diffuseColor;\n" // would have been nice to have had a real specular map but this will do
